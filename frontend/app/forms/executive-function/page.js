...
export default function ExecutiveFunctionForm() {
    ...
    useEffect(() => {
        fetch('http://localhost:4000/api/services/EXECUTIVE_FUNCTION')
            .then(res => res.json())
            .then(data => {
        ...
        <div className={styles.page}>
            <div className={styles.formContainer}>
                <div className={styles.formHeader}>
                    ...
                    <h1>Academic Coaching Registration</h1>
                    <p>Build essential skills for organization and academic success.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    ...
                    <div className={styles.formSection}>
                        ...
                        <textarea name="parentNotes" value={formData.parentNotes} onChange={handleChange} rows={3} placeholder="What are the main areas of concern? (e.g., organization, time management, focus)" />
                    </div>
